...
#endif
static const char *ng0 = "C:/Users/z/Documents/Projects/pipeline-cpu/PCPU/Control.v";
static int ng1[] = {0, 0};
...
LAB92:    xsi_vlog_unsigned_bit_combine(t10, 32, t30, 32, t35, 32);
    goto LAB96;

LAB94:    memcpy(t10, t30, 8);
    goto LAB96;
...
LAB105:    xsi_vlog_unsigned_bit_combine(t10, 32, t30, 32, t35, 32);
    goto LAB109;

LAB107:    memcpy(t10, t30, 8);
    goto LAB109;
...
LAB118:    xsi_vlog_unsigned_bit_combine(t10, 32, t30, 32, t35, 32);
    goto LAB122;

LAB120:    memcpy(t10, t30, 8);
    goto LAB122;
...
LAB94:    xsi_set_current_line(207, ng0);
...
LAB97:    memcpy(t43, t19, 8);

LAB98:    memset(t84, 0, 8);
    t57 = (t43 + 4);
    t76 = *((unsigned int *)t57);
    t77 = (~(t76));
    t78 = *((unsigned int *)t43);
...
LAB46:    xsi_set_current_line(219, ng0);
    t158 = ((char*)((ng5)));
    t159 = (t0 + 9184);
    xsi_vlogvar_assign_value(t159, t158, 0, 0, 2);
    goto LAB48;
...
LAB74:    *((unsigned int *)t99) = 1;
    goto LAB77;

LAB78:    *((unsigned int *)t113) = 1;
    goto LAB81;
...
LAB85:    xsi_set_current_line(221, ng0);
    t124 = ((char*)((ng3)));
    t125 = (t0 + 9184);
...
LAB175:    memcpy(t43, t19, 8);

LAB176:    memset(t84, 0, 8);
    t57 = (t43 + 4);
    t76 = *((unsigned int *)t57);
    t77 = (~(t76));
    t78 = *((unsigned int *)t43);
...
LAB214:    memcpy(t43, t19, 8);

LAB215:    memset(t84, 0, 8);
    t57 = (t43 + 4);
    t76 = *((unsigned int *)t57);
    t77 = (~(t76));
    t78 = *((unsigned int *)t43);
...
LAB196:    if (*((unsigned int *)t85) != 0)
        goto LAB197;

LAB198:    t102 = *((unsigned int *)t84);
    t103 = *((unsigned int *)t113);
    t104 = (t102 & t103);
    *((unsigned int *)t120) = t104;
    t100 = (t84 + 4);
...
LAB191:    *((unsigned int *)t99) = 1;
    goto LAB194;

LAB195:    *((unsigned int *)t113) = 1;
    goto LAB198;
...
LAB231:    if (*((unsigned int *)t81) != 0)
        goto LAB232;

LAB233:    t94 = *((unsigned int *)t84);
    t95 = *((unsigned int *)t99);
    t96 = (t94 & t95);
    *((unsigned int *)t113) = t96;
    t85 = (t84 + 4);
...
extern void work_m_00000000001998764582_2058220583_init()
{
	static char *pe[] = {(void *)Always_39_0,(void *)Always_194_1,(void *)Always_214_2};
	xsi_register_didat("work_m_00000000001998764582_2058220583", "isim/PCPU_sim_isim_beh.exe.sim/work/m_00000000001998764582_2058220583.didat");
